...
public class State {
	...
	public  float poll_elapsed_time = 0;
	public final float poll_period = 0.3f;
	public StringBuilder tcp_frame_message;

	public String[] next_state_inf;
	public float frame_delta_time = 0;
